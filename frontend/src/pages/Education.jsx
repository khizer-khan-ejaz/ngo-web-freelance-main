        ...
        <div className="container">
          <div className="row align-items-center py-5">
            <div className="col-md-8 text-white">
              <h1 className="text-[80px]" style={{color:"rgba(var(--bs-success-rgb), var(--bs-text-opacity)) !important"}}> Education </h1>
              <p className="text-gray-200" style={{color:"black"}}>
              PHRMS’ Educational Support initiative is designed to bridge the gap for children from low-income families who face financial barriers to accessing quality education. This program includes several key components:
 Financial Assistance
School Fees and Tuition: PHRMS provides direct financial aid to cover tuition fees for children attending schools that charge for education. This ensures that children are not denied access due to their inability to pay.
              </p>
            </div>
